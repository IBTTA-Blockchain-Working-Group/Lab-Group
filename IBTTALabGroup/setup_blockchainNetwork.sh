...
if [ "$(kubectl get pvc | grep pvc | awk '{print $2}')" != "Bound" ]; then
    ...
    echo "Running: kubectl create -f ${KUBECONFIG_FOLDER}/create_volume.yaml"
    kubectl create -f ${KUBECONFIG_FOLDER}/create_volume.yaml
    sleep 5
...
echo "Running: kubectl create -f ${KUBECONFIG_FOLDER}/copy_artifacts.yaml"
kubectl create -f ${KUBECONFIG_FOLDER}/copy_artifacts.yaml
...
echo "Running: kubectl create -f ${KUBECONFIG_FOLDER}/generate_artifacts.yaml"
kubectl create -f ${KUBECONFIG_FOLDER}/generate_artifacts.yaml
...
echo "Running: kubectl create -f ${KUBECONFIG_FOLDER}/blockchain_services.yaml"
kubectl create -f ${KUBECONFIG_FOLDER}/blockchain_services.yaml


# Create peers, ca, orderer using Kubernetes Deployments
echo -e "\nCreating new Deployment to create four peers in network"
echo "Running: kubectl create -f ${KUBECONFIG_FOLDER}/peers_deployment.yaml"
kubectl create -f ${KUBECONFIG_FOLDER}/peers_deployment.yaml
